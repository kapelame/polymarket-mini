...
export default function PriceChart() {
  ...
  useEffect(() => {
    ...
    grad.addColorStop(0, "rgba(22,199,132,0.2)");
  ...
  const pct = yesPrice !== null ? Math.round(yesPrice * 100) : null;
        ...
        <div style={{ display: "flex", gap: 12 }}>
          {[
            ...
            <div key={label} style={{
              ...
              <div style={{ fontSize: 11, color, fontWeight: 500, marginBottom: 4, opacity: 0.8 }}>{label}</div>
